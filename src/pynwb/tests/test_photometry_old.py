...
#
#     def test_bad_photodetector_reference(self):
#         msg = 'Reference to photodetectors that does not yet exist'
...
#
#
# class TestPhotodetectorsTable(TestCase):
#
#     def test_init(self):
#         photodetectors = PhotodetectorsTable(
