...
# Next Steps for ndx-photometry Extension for NWB

## Creating Your Extension

1. In a terminal, change directory into the new ndx-photometry directory: `cd ndx-photometry`
...
`spec/ndx-photometry.namespace.yaml` and
`spec/ndx-photometry.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-photometry
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.5.0, then this page should exist: https://github.com/catalystneuro/ndx-photometry/releases/tag/0.5.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).
...
9. Publish your updated extension on [PyPI](https://pypi.org/).
    ...
    - If your extension version is 0.5.0, then this page should exist: https://pypi.org/project/ndx-photometry/0.5.0
...
`staged-extensions/ndx-photometry`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-photometry
    ```

13. Edit `staged-extensions/ndx-photometry/ndx-meta.yaml`
with information on where to find your NWB extension.
    ...
    - You may copy and modify the following YAML that was auto-generated:
      ...
      name: ndx-photometry
      version: 0.5.0
      src: https://github.com/catalystneuro/ndx-photometry
      pip: https://pypi.org/project/ndx-photometry/
      license: BSD-3
      maintainers:
        - akshay-jaggi
        - bendichter
...
14. Edit `staged-extensions/ndx-photometry/README.md`
to add information about your extension. You may copy it from
`ndx-photometry/README.md`.

  ```bash
  cp ndx-photometry/README.md staged-extensions/ndx-photometry/README.md
  ```

15. Add and commit your changes to Git and push your changes to GitHub.
```
cd staged-extensions
git add ndx-photometry
git commit -m "Add new catalog entry for ndx-photometry" .
git push
```
...
ndx-photometry-record will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-photometry GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-photometry-record repository on GitHub.
